...
struct MinimalConfettiViewObservableObject: View {
    @StateObject private var viewModel = ConfettiViewModelObservableObject()
...
#Preview {
    MinimalConfettiViewObservableObject()
}
